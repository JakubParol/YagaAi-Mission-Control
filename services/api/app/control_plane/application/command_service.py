...
class CommandService:
    def __init__(self, repo: CommandRepository) -> None:
        self._repo = repo
        self._default_max_attempts = settings.control_plane_retry_max_attempts
    ...
    async def submit_command(
        ...
        *,
        ...
        log_event(
            logger,
            level=logging.INFO,
            event="control-plane.command.accepted",
    ...
    def _build_delivery_metadata(
        ...
        *,
        ...
        next_backoff_seconds = min(
            ...
            settings.control_plane_retry_max_backoff_seconds,
        )
        return {
