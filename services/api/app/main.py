...
from app.control_plane.api.agent_queue import router as control_plane_agent_queue_router
...
app.include_router(control_plane_agent_queue_router, prefix="/v1/control-plane")
